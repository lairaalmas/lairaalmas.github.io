        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <li><a class="dropdown-item" target="_self" href='./paginas/area_professor/page_2.html'>Sou Professor</a>
              </li>
              <li><a class="dropdown-item" target="_self" href='./paginas/area_professor/page_1.html'>Sou
                  Administrador Moodle</a>
              </li>
              <li><a class="dropdown-item" target="_self" href='./paginas/area_programador/page_1.html'>Sou
                  Desenvolvedor</a>
              </li>
            </ul>
          </li>
